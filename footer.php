...
<h3>Shopping Portal</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> I love ordering things online because when they arrive <br>it’s like a present for me, from me.</p>
        ...
        <ul class="toggle-footer" >
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+91) 0000000000<br>(+91) 7050659072</p>
                </div>
            </li>
  
              <li class="media">
               <!-- extra popup    <div class="pull-left">
                     <span class="icon fa-stack fa-lg">
                      <i class="fa fa-circle fa-stack-2x"></i>
